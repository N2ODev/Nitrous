...
// nitrous: total coins staked (non-spendable until maturity)
...
// nitrous: check 'spent' consistency between wallet and txindex
// nitrous: fix wallet spent state according to txindex
...
// nitrous: disable transaction (only for coinstake)
