...
SendCoinsDialog::SendCoinsDialog(QWidget *parent) :
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Nitrous address (e.g. B8j4S6kBqDVYcMcQTjPmiSVu24YRwS94SA)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text) {
    if (model) {
        ...
        if (text.isEmpty()) {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Nitrous address"));
        } else {
