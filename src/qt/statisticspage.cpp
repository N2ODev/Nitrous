...
void StatisticsPage::updateStatistics() {
    ...
    if (pindexBest->nHeight < 15001) {
        phase = "<p align=\"center\">(1) POW</p>";
    } else if (pindexBest->nHeight > 15000 && pindexBest->nHeight < 20001) {
        phase = "<p align=\"center\">(2) POW - POS</p>";
        ui->progressBar->setMinimum(15000);
        ui->progressBar->setMaximum(20000);
    } else if (pindexBest->nHeight > 20000 && pindexBest->nHeight < 160001) {
        phase = "<p align=\"center\">(3) Full POS</p>";

        ui->progressBar->setMinimum(20000);
        ui->progressBar->setMaximum(160000);
    } else {
        ui->progressBar->hide();
    ...
    if (volume > volumePrevious) {
        ui->volumeBox->setText("<font color=\"green\">" + qVolume + " N2O" + "</font>");
    } else if (volume < volumePrevious) {
        ui->volumeBox->setText("<font color=\"red\">" + qVolume + " N2O" + "</font>");
    } else {
        ui->volumeBox->setText(qVolume + " N2O");
    }
