...
// Copyright (c) 2014 The Nitrous developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("nitrous-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("nitrous-smsg-pow"); // Make this thread recognisable
